...
final class PaymentSystem
{
    ...
    public static function provider(PaymentGatewayContract|Closure $providerOrClosure): void
    {
        ...
        if (!$providerOrClosure instanceof PaymentServiceProvider) {
    ...
    {
        if (!self::$provider instanceof PaymentServiceProvider) {
            throw PaymentProviderException::providerRequired();
        }
            ...
            try {
                $payment = Payment::query()
                    ...
                    ->firstOr(static function () {
                        throw PaymentProcessException::providerRequired();
                    });
