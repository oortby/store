        ...
        <div class="flex flex-wrap lg:flex-nowrap items-center">
            <div class="footer-logo order-0 basis-full sm:basis-1/2 lg:basis-1/3 shrink-0 text-center sm:text-left">
                <a href="{{ route('home') }}" class="inline-block" rel="home">
                    <img src="{{ Vite::image('logo-dark.svg') }}" class="w-[155px] h-[38px]" alt="OrangePort Store">
                </a>
            </div><!-- /.footer-logo -->
            ...
            <div class="container">
                ...
                <div class="mmenu-inner pt-10">
                    ...
                    <div class="flex items-center">
                        <img src="{{ Vite::image('avatar.jpg')}}" class="w-14 h-14 rounded-full" alt="Данил Шуцкий">
                        <div class="flex flex-col items-start ml-4">
                            <span class="text-dark text-xs md:text-sm font-bold">{{ auth()->user()->name?? ''  }}</span>
                            <a href="{{ route('logOut') }}" class="inline-flex items-center text-dark hover:text-pink">
