                        ...
                        <tr>
                            <td scope="row" class="py-4 px-4 md:px-6 rounded-l-2xl bg-card">
                                <div class="flex flex-col lg:flex-row min-w-[200px] gap-2 lg:gap-6">
                                    <div
                                        ...
                                        <img src="{{ $item->product->makeThumbnail('345x320') }}"
                                    ...
                                    <div class="py-3">
                                        <h4 class="text-xs sm:text-sm xl:text-md font-bold">
                                            <a href="#"
                                               class="inline-block text-white hover:text-pink">{{ $item->product->title }}
                                            </a>
                                        </h4>
                            ...
                            <td class="py-4 px-4 md:px-6 rounded-r-2xl bg-card">
                                <form method="POST" action="{{ route('cart.delete', $item) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" href="#" class="w-12 !h-12 !px-0 btn btn-pink"
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-8">
                ...
                <div class="pb-3 lg:pb-0">
                    <form method="POST" action="{{ route('cart.truncate') }}">
                        ...
                        <button href="#" class="text-body hover:text-pink font-medium">Очистить корзину</button>
                    </form>
                </div>
