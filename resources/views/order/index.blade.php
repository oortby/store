                            ...
                            <div class="space-y-3">
                                <div class="form-radio">
                                    ...
                                    <label for="delivery-method-address-{{ $delivery->id }}"
                                           class="form-radio-label">-{{ $delivery->title }}</label>
                                </div>
                        ...
                        @foreach($payments as $payment)
                            <div class="form-radio">
                                ...
                                <label for="payment-method-{{ $payment->id }}"
                                       class="form-radio-label">{{ $payment->title }}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <table class="w-full border-spacing-y-3 text-body text-xxs text-left" style="border-collapse: separate">
                    ...
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td class="px-2 pb-3 border-b border-body/20 whitespace-nowrap">{{ $item->quantity }}шт.
                            </td>
